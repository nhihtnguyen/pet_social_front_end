                        ...
                        {todoData.data.map((todo, index) =>
                            ...
                            >
                                <InputGroup>
                                    ...
                                    />
                                    {todo.status === 'planned'
                                        ? <Form.Label htmlFor={`todo-${index}`}>{todo.name}</Form.Label>
                                        : <Form.Label htmlFor={`todo-${index}`} style={{ textDecoration: 'line-through' }}>{todo.name}</Form.Label>
                                    }
                                </InputGroup>
                            </ListGroup.Item>).reverse()}
                    </ListGroup>
                }
            </div>
        </>
